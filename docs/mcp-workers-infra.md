...
- Nothing in the local CLI stack (op-gws, op-freeagent, whatsapp-bridge) is
  touched by this work. The op-mcp socket bridge that used to sit alongside it
  was retired once the gateway reached parity.
